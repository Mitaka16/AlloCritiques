export const MovieList = [
    ...
    },
    {
        ...
        actors: ['Tom Hanks, ', 'Micheal Clarke Duncan, ', 'David Morse'],
        plot: 'Paul Edgecomb, pensionnaire centenaire d\'une maison de retraite, est hanté par ses souvenirs. Gardien-chef du pénitencier de Cold Mountain en 1935, il était chargé de veiller au bon déroulement des exécutions capitales en s’efforçant d\'adoucir les derniers moments des condamnés. Parmi eux se trouvait un colosse du nom de John Coffey, accusé du viol et du meurtre de deux fillettes. Intrigué par cet homme candide et timide aux dons magiques, Edgecomb va tisser avec lui des liens très forts.',
        country: 'USA',
    ...
    },
    {
        id: 'LE4',
        title: 'Les Evadés',
        released: '1 mars 1995',
        year: 1995,
        runtime: 140,
        genre: ['Drame'],
        director: 'Frank Darabont',
        actors: ['Tim Robbins, ', 'Morgan Freeman, ', 'Bob Gunton'],
        plot: 'En 1947, Andy Dufresne, un jeune banquier, est condamné à la prison à vie pour le meurtre de sa femme et de son amant. Ayant beau clamer son innocence, il est emprisonné à Shawshank, le pénitencier le plus sévère de l\'Etat du Maine. Il y fait la rencontre de Red, un Noir désabusé, détenu depuis vingt ans. Commence alors une grande histoire d\'amitié entre les deux hommes...',
        country: 'USA',
        poster: 'https://fr.web.img6.acsta.net/c_310_420/medias/nmedia/18/63/30/68/18686447.jpg',
        Ratings: [
            {
                Source: '',
                Value: ''
    ...
    },
    {
        ...
        actors: ['Matthew McConaughey, ', 'Anne Hathaway, ', 'Micheal Caine'],
        plot: 'Le film raconte les aventures d’un groupe d’explorateurs qui utilisent une faille récemment découverte dans l’espace-temps afin de repousser les limites humaines et partir à la conquête des distances astronomiques dans un voyage interstellaire.',
        country: 'USA',
    ...
    },
    {
        ...
        released: '9 novembre 2016',
        year: 2016,
        runtime: 140,
        genre: ['Drame, ', 'Biopic'],
        director: 'Mel Gibson',
        actors: ['Andrew Garfield, ', 'Vince Vaughn, ', 'Teresa Palmer'],
        plot: 'Quand la Seconde Guerre mondiale a éclaté, Desmond, un jeune américain, s’est retrouvé confronté à un dilemme : comme n’importe lequel de ses compatriotes, il voulait servir son pays, mais la violence était incompatible avec ses croyances et ses principes moraux. Il s’opposait ne serait-ce qu’à tenir une arme et refusait d’autant plus de tuer. Il s’engagea tout de même dans l’infanterie comme médecin. Son refus d’infléchir ses convictions lui valut d’être rudement mené par ses camarades et sa hiérarchie, mais c’est armé de sa seule foi qu’il est entré dans l’enfer de la guerre pour en devenir l’un des plus grands héros. Lors de la bataille d’Okinawa sur l’imprenable falaise de Maeda, il a réussi à sauver des dizaines de vies seul sous le feu de l’ennemi, ramenant en sureté, du champ de bataille, un à un les soldats blessés.',
        country: 'USA',
        poster: 'https://fr.web.img6.acsta.net/c_310_420/pictures/16/09/02/19/16/302469.jpg',
        Ratings: [
            {
                Source: '',
                Value: ''
